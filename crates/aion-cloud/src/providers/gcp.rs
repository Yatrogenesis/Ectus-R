...
// use google_cloud_compute::http::instances::get::GetInstanceRequest; // Package not available
// use google_cloud_storage::http::buckets::list::ListBucketsRequest; // Not used in mock implementation
use serde_json::json;
